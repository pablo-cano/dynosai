...
export const metadata: Metadata = {
  title: "Validation",
  description: "How the DynosAI 0.14.1 product layer preserves the 0.13.0 certified governed core while adding deterministic Studio and application-layer regression coverage.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
      <div className="max-w-3xl">
        <Badge>β Public beta · 0.14.1</Badge>
        ...
        <p className="mt-6 text-lg leading-8 text-muted-foreground">DynosAI 0.14.1 preserves the accepted 0.13.0 governed-core behavior while adding a local App Server and Studio regression layer. The real-provider Green/Brown matrix shown below remains the core provider baseline; 0.14 adds deterministic application, risk, validation-discovery and packaged-Studio checks without expanding agent authority.</p>
      </div>
