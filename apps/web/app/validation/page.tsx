...
export const metadata: Metadata = {
  title: "Validation",
  description: "How DynosAI 0.13.0 was evaluated across Codex, Cursor, greenfield, brownfield, deterministic regression, recovery, and installed-wheel tests.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
      <div className="max-w-3xl">
        <Badge>β Public beta · 0.13.0</Badge>
        ...
        <p className="mt-6 text-lg leading-8 text-muted-foreground">The current beta preserved the accepted RC behavior and is backed by deterministic regression, recovery and fault-injection tests, provider-native checks, installed-wheel certification, and a real-provider Green/Brown matrix.</p>
      </div>
