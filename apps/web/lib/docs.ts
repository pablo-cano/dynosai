...
export const docs: DocDefinition[] = [
  ...
  { slug: "studio", title: "Local Studio", description: "Launch the loopback-only graphical control plane and understand its application/API, validation and risk boundaries.", source: "docs/STUDIO.md", group: "Start", order: 25 },
