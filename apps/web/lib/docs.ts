...
export const docs: DocDefinition[] = [
  ...
  { slug: "release-1-0-0-rc-7", title: "1.0.0-rc.7 release notes", description: "Certification integrity and protocol correctness. Release archive safety, MCP 2026 strict metadata/MRTR, MATRIX runner honesty. Not production-ready 1.0.", source: "docs/RELEASE_1.0.0-rc.7.md", group: "Project", order: 131 },
  { slug: "release-1-0-0-rc-6", title: "1.0.0-rc.6 release notes", description: "Standards and release evidence: MCP 2026 compatibility, unified release gate, eval corpus and distribution ADR. Not production-ready 1.0.", source: "docs/RELEASE_1.0.0-rc.6.md", group: "Project", order: 132 },
