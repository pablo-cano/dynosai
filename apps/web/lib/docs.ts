...
export const docs: DocDefinition[] = [
  ...
  { slug: "roadmap", title: "Roadmap", description: "The post-beta direction for DynosAI without changing the guarantees of the 0.13.0 baseline.", source: "ROADMAP.md", group: "Project", order: 180 },
