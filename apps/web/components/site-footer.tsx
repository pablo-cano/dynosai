      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 text-sm text-muted-foreground sm:grid-cols-2 lg:px-8">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="rounded-full border border-border px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide">Beta</span>
          </div>
          ...
          <p className="mt-3 max-w-xl leading-6">Public beta. External pull requests are not currently accepted while the public API and contribution model stabilize. Feedback and bug reports are welcome.</p>
        </div>
