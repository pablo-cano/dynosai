    ...
    <footer className="border-t border-border">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 text-sm text-muted-foreground sm:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-3 max-w-xl leading-6">Public RC · Installation. External pull requests are not currently accepted while the public API and contribution model stabilize. Feedback and bug reports are welcome.</p>
        </div>
