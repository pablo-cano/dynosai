...
Pre-1.0 used semantic-style numbering. From 1.0 release candidates, Python/package versions follow PEP 440 (`1.0.0rc1`). Display surfaces may show `1.0.0-rc.1`.
...
```bash
git tag -a v1.0.0-rc.1 -m "DynosAI 1.0.0-rc.1"
```
