...
For that reason the **beta runtime baseline keeps predictive routing in shadow mode**. The evidence is useful for research and future releases, and 0.15.0 still does not delegate autonomous model spending to it.
