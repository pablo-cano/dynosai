...
For that reason the **beta runtime baseline keeps predictive routing in shadow mode**. The evidence is useful for research and future releases, but 0.13.0 does not delegate autonomous model spending to it.
