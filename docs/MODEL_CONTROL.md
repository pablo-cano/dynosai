...
For that reason the **RC runtime keeps predictive routing in shadow mode**. The evidence is useful for research and future releases, and `1.0.0-rc.7` still does not delegate autonomous model spending to it.
